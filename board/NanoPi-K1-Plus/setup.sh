...
#
nanopi_k1_plus_cpoy_dtb () {
   if [ -f ${BOARD_FREEBSD_MOUNTPOINT}/boot/dtb/allwinner/sun50i-h5-nanopi-k1-plus.dtb ] ; then
	cp ${BOARD_FREEBSD_MOUNTPOINT}/boot/dtb/allwinner/sun50i-h5-nanopi-k1-plus.dtb \
		${BOARD_FREEBSD_MOUNTPOINT}/boot/dtb/sun50i-h5-nanopi-k1-plus.dtb
   fi
}
...
PRIORITY=40  strategy_add $PHASE_FREEBSD_OPTION_INSTALL nanopi_k1_plus_cpoy_dtb
